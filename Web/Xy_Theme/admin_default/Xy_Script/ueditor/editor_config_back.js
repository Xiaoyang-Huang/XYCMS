...
(function () {
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        , imageManagerPath: XY_WEBSITE_URL + "/Upload/ArticleContent/"                                   //图片修正地址，同imagePath
        ...
        , toolbars: [
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage', 'emotion', 'insertvideo', 'attachment', 'map', 'gmap', 'insertframe', 'highlightcode'
        //, 'webapp'
                , 'pagebreak', '|',
