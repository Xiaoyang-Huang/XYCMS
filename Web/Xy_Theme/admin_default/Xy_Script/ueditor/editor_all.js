...
(function () {
    ...
    Editor.prototype = {
         ...
         * })
         */
        getContent:function ( cmd, fn, isPreview, unchangeContent ) {
			var me = this;
			if(!unchangeContent){
         ...
         * })
         */
        setContent:function ( html, notFireSelectionchange , unchangeContent) {
            var me = this,
...
//            }
    ...
    UE.plugins['source'] = function (){
		...
		//解决在源码模式下setContent不能起作用的问题
		var oldSetContent = me.setContent;
            ...
            execCommand: function (){
                ...
                if (sourceMode) {
                    ...
                    me.getContent = function (){
                        ...
                        cont = cont.replace(/>[\n\r\t]+([ ]{4})+/g,'>').replace(/[\n\r\t]+([ ]{4})+</g,'<').replace(/>[\n\r\t]+</g,'><');
                        me.setContent(cont,true, true);
                        return oldGetContent.apply(this, [null,null,null,true]);
                    };
					
					//重置setContent, 源码模式下也能设置数据
					me.setContent = function(_incontent, hold){
						oldSetContent.apply(this, [_incontent, hold, true]);
						sourceEditor.setContent(_incontent)
					}
                } else {
