...
$(function()
{
	...
	// datepicker
	//if ($('#datepicker').length) $("#datepicker").datepicker({ showOtherMonths:true, dateFormat:"yy-mm-dd" });
	if ($('#datepicker-inline').length) $('#datepicker-inline').datepicker({ inline: true, showOtherMonths: true, dateFormat: "yy-mm-dd" });
